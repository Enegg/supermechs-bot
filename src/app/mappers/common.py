...
LITERAL_TYPE_TO_ENUM: abc.Mapping[str, sm.Item.Type] = {
...
LITERAL_ELEMENT_TO_ENUM: abc.Mapping[str, sm.Item.Element] = {
...
LITERAL_TIER_TO_ENUM: abc.Mapping[str, sm.Item.Rarity] = {
...
def convert_stats(stats: ItemStatsDto, /) -> sm.ItemStats:
    return sm.ItemStats(
        ...
        range=stats.range[0],
        range_addon=stats.range[1],  # note: can be -1
        push=stats.push,
        pull=stats.pull,
        recoil=stats.recoil,
